...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      {
        text: '其他文章',
        items: [{ text: 'Milthm 社区衍生内容创作守则', link: 'https://milthm.com/agreement/derivative/' },{ text: 'Milthm 社区衍生内容创作守则 常见问题解答', link: 'https://milthm.com/wiki/hans/faq/derivative_policy' }]
      }    ],
    outline: { level: [2, 4] },
